...
TEST_F(besm6, precedence_add_mul)
{
...
TEST_F(besm6, precedence_mul_add_mul)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_sub_div)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_mod_add)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_add_lt)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_eq_and)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_and_or)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_mul_add_lt)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_mul_ge_eq)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_mul_and_add)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_div_add_gt_or)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_div_mod)
{
    auto output = compile_and_run(R"(
        main() {
...
TEST_F(besm6, precedence_mul_or)
{
    auto output = compile_and_run(R"(
        main() {
