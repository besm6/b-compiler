...
//
// Compound assignment operators are not supported by PDP-7 version of B compiler.
//
TEST_F(besm6, DISABLED_assign_add)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_subtract)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_multiply)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_divide)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_modulo)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_shift_left)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_less_or_equal)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_less_than)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_shift_right)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_greater_or_equal)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_greater_than)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_not_equal)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_equal)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_and)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
...
TEST_F(besm6, DISABLED_assign_or)
{
    auto output = compile_and_run(R"(
        main() {
            auto x;
